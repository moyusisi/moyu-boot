...
values  (2001, '0', '系统模块', 'sys_module', 1, '/sysModule', 'Layout', 'appstore-add-outlined', '', 1, null, 'sys_module', 1, null, '', 0, null, null, null, null),
        ...
        (2131, 'menu_sys_role', '授权功能权限', 'btn_sys_role_grantMenu', 6, '/api/sys/role/grantMenu', null, null, 'sys:role:grantMenu', 1, null, 'sys_module', 202009, null, null, 0, null, null, null, null),
        (2132, 'menu_sys_role', '授权数据权限', 'btn_sys_role_grantScope', 6, '/api/sys/role/grantScope', null, null, 'sys:role:grantScope', 1, null, 'sys_module', 202010, null, null, 0, null, null, null, null),

        (2133, 'menu_sys_module', '新增模块', 'btn_sys_module_add', 6, '/api/sys/resource/add', '', null, 'sys:resource:add', 1, null, 'sys_module', 301001, null, null, 0, null, null, null, null),
        (2134, 'menu_sys_module', '删除模块', 'btn_sys_module_delete', 6, '/api/sys/resource/delete', '', null, 'sys:resource:delete', 1, null, 'sys_module', 301002, null, null, 0, null, null, null, null),
        (2135, 'menu_sys_module', '修改模块', 'btn_sys_module_edit', 6, '/api/sys/resource/add', '', null, 'sys:resource:edit', 1, null, 'sys_module', 301003, null, null, 0, null, null, null, null),
        ...
        (2137, 'menu_sys_module', '模块详情', 'btn_sys_module_detail', 6, '/api/sys/resource/detail', '', null, 'sys:resource:detail', 1, null, 'sys_module', 301005, null, null, 0, null, null, null, null),

        (2138, 'menu_sys_menu', '新增菜单', 'btn_sys_menu_add', 6, '/api/sys/resource/add', '', '', 'sys:resource:add', 1, null, 'sys_module', 302001, null, '', 0, null, null, null, null),
        (2139, 'menu_sys_menu', '删除菜单树', 'btn_sys_menu_deleteTree', 6, '/api/sys/resource/deleteTree', '', null, 'sys:resource:deleteTree', 1, null, 'sys_module', 302002, null, null, 0, null, null, null, null),
        (2140, 'menu_sys_menu', '修改菜单', 'btn_sys_menu_edit', 6, '/api/sys/resource/edit', '', null, 'sys:resource:edit', 1, null, 'sys_module', 302003, null, null, 0, null, null, null, null),
        (2141, 'menu_sys_menu', '菜单树', 'btn_sys_menu_tree', 6, '/api/sys/resource/tree', '', null, 'sys:resource:detail', 1, null, 'sys_module', 302004, null, null, 0, null, null, null, null),
        (2142, 'menu_sys_menu', '菜单详情', 'btn_sys_menu_detail', 6, '/api/sys/resource/detail', '', null, 'sys:resource:detail', 1, null, 'sys_module', 302005, null, null, 0, null, null, null, null),

        (2143, 'menu_sys_button', '新增按钮', 'btn_sys_button_add', 6, '/api/sys/resource/add', '', null, 'sys:resource:add', 1, null, 'sys_module', 303001, null, null, 0, null, null, null, null),
        (2144, 'menu_sys_button', '删除按钮', 'btn_sys_button_delete', 6, '/api/sys/resource/delete', '', null, 'sys:resource:delete', 1, null, 'sys_module', 303002, null, null, 0, null, null, null, null),
        (2145, 'menu_sys_button', '修改按钮', 'btn_sys_button_edit', 6, '/api/sys/resource/add', '', null, 'sys:resource:edit', 1, null, 'sys_module', 303003, null, null, 0, null, null, null, null),
        (2146, 'menu_sys_button', '按钮列表', 'btn_sys_button_list', 6, '/api/sys/resource/page', '', null, 'sys:resource:page', 1, null, 'sys_module', 303004, null, null, 0, null, null, null, null),
        (2147, 'menu_sys_button', '按钮详情', 'btn_sys_button_detail', 6, '/api/sys/resource/detail', '', null, 'sys:resource:detail', 1, null, 'sys_module', 303005, null, null, 0, null, null, null, null),

        (2148, 'menu_sys_session', '强制退出', 'btn_sys_session_delete', 6, '/api/auth/session/delete', '', null, 'auth:session:delete', 1, null, 'sys_module', 303002, null, null, 0, null, null, null, null),
        (2149, 'menu_sys_session', '强退令牌', 'btn_sys_session_deleteToken', 6, '/api/auth/session/deleteToken', '', null, 'auth:session:deleteToken', 1, null, 'sys_module', 303002, null, null, 0, null, null, null, null),
        (2150, 'menu_sys_session', '会话列表', 'btn_sys_session_list', 6, '/api/auth/session/page', '', null, 'auth:session:page', 1, null, 'sys_module', 303004, null, null, 0, null, null, null, null),
